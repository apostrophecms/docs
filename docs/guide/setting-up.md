...
Now that Apostrophe is installed, you're ready to start building. Check out the [guide](/guide/modules.html) to learn about essential features with plenty of code examples. If you are looking to use Apostrophe API as a headless CMS or explore Apostrophe's inner workings peruse the [reference guide](/reference/glossary.md). 
