...
Hostname and the path prefix are both factors in deciding what locale to display to visitors. There is prioritzation that factors into identifying the correct one to use. The priority ranking for choosing the correct locale is:
