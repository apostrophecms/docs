...
Setting this option globally enables the behavior for all widgets. To enable or disable it for specific widgets only, set the option in the individual widget's configuration.
