...
|`if` | Object | `{}` | Conditions to meet before the field is active. See below. |
...
<!-- Importing choices description -->
<Content :page-key="$site.pages.find(p => p.relativePath === 'reference/field-types/_conditional-setting.md').key"/>
