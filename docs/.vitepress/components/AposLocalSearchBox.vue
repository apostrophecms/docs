      ...
      <div class="shell">
        <form class="search-bar" @pointerup="onSearchBarClick" @submit.prevent="">
          ...
          <div class="search-actions">
            <button class="toggle-search-type-button" :class="{'highlighted': filterText.length > 0 && !isAISearchActive}" type="button" :title="dynamicLabel" @click="toggleSearchType">
...
.toggle-search-type-button.highlighted {
  background-color: #ecfdf5;
  border: 2px solid #d2f9e5;
  color: #04976b;
}

.toggle-search-type-button.highlighted:hover,
.toggle-search-type-button.highlighted:active {
  background-color: #ecfdfb;
}
.toggle-search-type-button.highlighted:focus {
  outline: none;
  box-shadow: 0 0 0 2px #d2f9e5;
}
